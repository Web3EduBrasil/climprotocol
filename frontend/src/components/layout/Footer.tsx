        ...
        <div className="glass rounded-2xl p-6 mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-sm font-bold text-[var(--text-primary)]">Built with Chainlink CRE</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="bg-[var(--surface-input)] rounded-xl p-3 border border-[var(--border)]">
                <HiOutlineCpuChip className="w-4 h-4 text-[#2A5ADA] mb-1.5" />
                <p className="text-xs font-semibold text-[var(--text-primary)]">CRE Workflow</p>
                <p className="text-[10px] text-[var(--text-muted)] mt-0.5">Cron-triggered settlement orchestration on DON</p>
              </div>
              <div className="bg-[var(--surface-input)] rounded-xl p-3 border border-[var(--border)]">
                <HiOutlineGlobeAlt className="w-4 h-4 text-[var(--accent)] mb-1.5" />
                <p className="text-xs font-semibold text-[var(--text-primary)]">Functions</p>
                <p className="text-[10px] text-[var(--text-muted)] mt-0.5">Serverless climate data from Open-Meteo API</p>
              </div>
              <div className="bg-[var(--surface-input)] rounded-xl p-3 border border-[var(--border)]">
                <HiOutlineBolt className="w-4 h-4 text-yellow-400 mb-1.5" />
                <p className="text-xs font-semibold text-[var(--text-primary)]">Automation</p>
                <p className="text-[10px] text-[var(--text-muted)] mt-0.5">Time-based triggers for event settlement</p>
              </div>
              <div className="bg-[var(--surface-input)] rounded-xl p-3 border border-[var(--border)]">
                <HiOutlineChartBar className="w-4 h-4 text-green-400 mb-1.5" />
                <p className="text-xs font-semibold text-[var(--text-primary)]">Data Feeds</p>
                <p className="text-[10px] text-[var(--text-muted)] mt-0.5">ETH/USD price feed for USD conversion</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--text-muted)]">
              ...
              <li><a href="https://docs.chain.link/cre" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] transition-colors">Chainlink CRE</a></li>
              <li><a href="https://docs.chain.link/data-feeds" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] transition-colors">Chainlink Data Feeds</a></li>
