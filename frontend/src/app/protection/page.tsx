      ...
      <div>
        ...
        {activeEvents.length === 0 ? (
          <div className="glass rounded-2xl p-10 text-center">
            <HiOutlineShieldCheck className="w-10 h-10 text-[var(--text-faint)] mx-auto mb-3" />
            <p className="text-sm text-[var(--text-muted)]">No protection events available.</p>
            <p className="text-xs text-[var(--text-faint)] mt-1">New events will be listed here when created.</p>
          </div>
        ) : (
